...
class MainWindow(QMainWindow):
    ...
    def create_percentage_bar_chart(self):
        ...
        set0 = QtCharts.QBarSet("Instagram Post")
        set1 = QtCharts.QBarSet("Facebook Post")
        set2 = QtCharts.QBarSet("Tweet&X")
        set3 = QtCharts.QBarSet("TikTok Videos")
        set4 = QtCharts.QBarSet("YouTube Shorts")
        ...
        chart.setTitle("Number of Likes and Views for Different Videos Over Time")
    ...
    def temperature_records(self):
        low = QtCharts.QBarSet("UnFolow")
        high = QtCharts.QBarSet("Folow")
        ...
        chart = QtCharts.QChart()
        chart.addSeries(series)
        chart.setTitle("Followers Bar Chart")
        chart.setAnimationOptions(QtCharts.QChart.SeriesAnimations)
        ...
        axisY.setTitleText("Number of Followers [&deg;NO]")
    ...
    def create_nested_donuts(self):
        ...
        self.chart.setTitle("Follower Distribution by Category")
    ...
    def create_line_chart(self):
        ...
        self.chart.setTitle("Daily Follower Growth")
    ...
    def create_bar_graph(self):
        self.set0 = QtCharts.QBarSet("Influencer A")
        self.set1 = QtCharts.QBarSet("Influencer B")
        self.set2 = QtCharts.QBarSet("Influencer C")
        self.set3 = QtCharts.QBarSet("Influencer D")
        self.set4 = QtCharts.QBarSet("Influencer E")
        ...
        self.chart.setTitle("Monthly Follower Growth by Influencer")
